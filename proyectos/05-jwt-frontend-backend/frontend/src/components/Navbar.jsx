    ...
    <nav className="bg-white shadow-lg">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <Link className="text-gray-800 text-xl font-bold p-4" to="/">Mi App</Link>
          <div className="flex space-x-4">
              <Link to="/" className="text-gray-800 hover: text-sky-800 px-4 py-2 rounded-md text-sm font-medium">Inicio</Link>
