      ...
      <ul>
        {tasks.map((task) => (
          ...
          >
            ...
            <button className="px-3 py-1 bg-blue-500 text-white rounded mr-2" onClick={()=>toggleTaskCompletion(task.id)}>
              Completar
            </button>
            <button className="px-3 py-1 bg-red-500 text-white rounded mr-2" onClick={()=>deleteTask(task.id)}>
              Eliminar
            </button>
          </li>
        ))}
